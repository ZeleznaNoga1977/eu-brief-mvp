// lib/extract2.js — simple, robust extractor
...
export function extractFields(raw) {
  ...
  // Programme detection (lightweight)
  let programme = "";
  ...
  // Deadlines only near “deadline/cut-off/closing/submission”
  ...
  // Budget: look for indicative/total budget or EU contribution
  let budget = null;
  const budgetLine =
  ...
  const expectedBlock = getBetween(
    text,
  ...
  return {
    ...
    trl,
    scope: scope || null,
    expected_outcomes: expectedBlock || null,
